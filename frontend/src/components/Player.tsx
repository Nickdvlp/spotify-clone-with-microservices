    ...
    <div>
      {song && (
        <div className="h-[10%] bg-black flex justify-between items-center text-white px-4">
          ...
          <div className="flex flex-col items-center gap- m-auto">
            {song.audio && (
              <audio ref={audioRef} src={song.audio} autoPlay={isPlaying} />
            )}
            <div className="w-full items-center flex font-thin text-green-500">
              <input
                type="range"
                min={"0"}
                max={"100"}
                className="progres-bar w-[120px] md:w-[300px]"
